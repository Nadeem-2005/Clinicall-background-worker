...
// // Redis connection config (Upstash-safe)
// const redisUrl = process.env.REDIS_URL;
// const redisConfig = redisUrl
//   ? {
//       url: redisUrl,
...
//     concurrency: 1,
//     settings: {
//       stalledInterval: 0, // CRITICAL: disables background Redis scans
//     },
//   }
// );
...
//       return { success: true };
//     } catch (error) {
//       console.error(`Notification failed → ${userId}`, error.message);
//       return { success: false, error: error.message };
//     }
//   },
//   {
...
// console.log('Redis usage optimized for Upstash');
// console.log('Concurrency: 1 (email + notification)');